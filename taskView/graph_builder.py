...
def get_entity_detail(filename: str, entity_name: str) -> dict[str, Any] | None:
    ...
    return {
        ...
        "args": entity.args,
        "pos": entity.pos,
        "index": getattr(entity, "index", 0) or 0,
        "view": getattr(entity, "view", "") or "",
        "settings": getattr(entity, "settings", "") or "",
        "match": getattr(entity, "match", "") or "",
        "context_get": getattr(entity, "context_get", "") or "",
        "context_default": getattr(entity, "context_default", "") or "",
